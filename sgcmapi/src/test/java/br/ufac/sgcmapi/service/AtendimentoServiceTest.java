...
public class AtendimentoServiceTest {
    ...
    void testAtendimentoGetTermoBusca() {
        // Tarefa de Casa
        String busca = "Ismael";
        Mockito.when(repo.busca(busca)).thenReturn(atendimentos);
        List<Atendimento> result = servico.get(busca);
        assertEquals(2, result.size());
    }
    ...
    void testAtendimentoSave() {
        ...
        a3.setId(3L);
        Mockito.when(repo.save(a3)).thenReturn(a3);
        Atendimento result = servico.save(a3);
